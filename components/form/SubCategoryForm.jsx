...
export default function SubCategoryForm({ selectedCategory, isEdit, onClose }) {
  ...
  // Get categories by department (level=0 for root categories)
  const { data: categoryData } = useGetCategoriesByDepartmentQuery(
    { departmentId: formData.departmentId, level: 0 },
  ...
  const handleSubmit = async (e) => {
    ...
    const loadingToast = toast.loading(
      isEdit ? "Updating sub category..." : "Creating sub category...",
    );
    ...
    handleToast({
      ...
      id: isEdit ? "update-subcategory" : "create-subcategory",
      message: isEdit
      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            >
              {isEdit ? "Update" : "Create"} Sub Category
            </Button>
          </div>
        </form>
      </div>
