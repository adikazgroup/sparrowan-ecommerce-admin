...
import { useCreateProductVariantMutation } from "@/features/products/productVariantsApiSlice";
...
export default function AddProductVariantPage() {
  ...
  const [image, setImage] = useState(null); // { file, url, name }
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await createVariant(generateFormData(payload));
    handleToast({
      result,
    ...
    <div className="bg-white dark:bg-[#010611] minBody p-5 rounded-xl space-y-6">
      <div className="flex items-center gap-3 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Create a new product variant</p>
        </div>
      </div>
