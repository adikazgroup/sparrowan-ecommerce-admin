...
import CategoryManageHeader from "@/components/section/categorySection/CategoryManageHeader";
import {
        ...
        {selectedCategory && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Link href={`/categories/edit/${selectedCategory._id}`}>
