...
import ChildCategoryManageHeader from "@/components/section/childCategorySection/ChildCategoryManageHeader";
import {
...
export default function ChildCategoriesPage() {
  ...
  const { data, isLoading, isError, refetch } = useGetCategoryListQuery({
    ...
    parent: subCategoryFilter || undefined,
    page,
    limit,
  });
  ...
  const confirmDelete = async () => {
    if (!selectedCategory?._id) {
      toast.error("Child category not selected");
      return;
    }
    ...
    },
    {
      ...
      cell: (_, row) => (
        <div className="flex justify-end gap-1">
          ...
          <Link
            href={`/child-categories/edit/${row._id}`}
        ...
        {selectedCategory && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Link href={`/child-categories/edit/${selectedCategory._id}`}>
